      ...
      <div className=" w-full shadow-md  px-4 md:px-6 ">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2 justify-self-end">
                ...
                <a href="/" className="inline-block" aria-label="Cruip">
                  <Image
                    className="max-w-full mx-auto md:max-w-none h-auto mt-14"
                    src={Logo}
                    width={60}
                    height={60}
                    alt="footer-Logo"
          ...
          <div className="md:flex md:items-center md:justify-between">
            {/* Social links */}
            <ul className="flex mb-4 md:order-1 md:ml-4">
              {/* twitter */}
              <li>
                <a
                  href="https://twitter.com/FinanceEdu23"
                  target="_blanck"
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy; Finance Education App. All rights reserved.
            </div>
          </div>
        </div>
      </div>
