...
function BlogEntry({ title, imageSrc }: blogProps) {
  return (
    <div className="max-w-4xl mx-auto rounded-xl sm:px-6 flex flex-col px-5 justify-center items-center mb-8">
      <h2 className="text-3xl font-bold text-purple-600 mb-2">{title}</h2>
      <div className=" max-w-md rounded overflow-hidden shadow-lg mb-10 ">
        <img className="w-full" src={imageSrc} alt={title} /></div>
      <div className="py-4 px-8">
        <h1 className="text-3xl font-bold mb-4  text-center">
          Antes de comenzar a invertir, es crucial que definas tus metas financieras
        </h1>
        ...
        <p className="mb-20 text-justify">
          Si no sabes cuál es el tuyo, <a href='/perfilInversor'>aquí puedes calcularlo.</a>
        </p>
        {/* <div
          data-aos="fade-up"
          data-aos-delay="100"
        ...
        >
          <YoutubeEmbed
            embedId={"CnTY-lNfXg8"}
            title={"Como crear tu propio fonde de emergencia"}
            description={"Preparate para cualquier contingencia"}
          />
        </div>
