...
export default function FCI(this: any) {
  return (
    <>
      <section>
        <BackButton />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4">Fondos comunes de inversión</h2>
              <p className="text-xl text-gray-400">Riesgos y tipos de fondos</p>
            </div>
            {/* Items */}
            <div
