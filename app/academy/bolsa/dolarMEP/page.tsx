...
export default function DolarMEP(this: any) {
  return (
    <>
      <section>
        <BackButton />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4">Dolar MEP</h2>
              <p className="text-xl text-gray-400">Como y donde comprarlo</p>
            </div>
            {/* Items */}
            <div
            ...
            >
              ...
              {Videos.dolarMEP.map((video, index) => (
                <div
                  data-aos="fade-up"
                  data-aos-delay="100"
