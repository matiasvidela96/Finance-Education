...
export default function Cedears(this: any) {
  return (
    <>
      <section>
        <BackButton />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4">Cedears</h2>
              <p className="text-xl text-gray-400">Comprar acciones de empresas internacionales en pesos</p>
            </div>
            {/* Items */}
            <div
            ...
            >
              ...
              {Videos.cedears.map((video, index) => (
                <div
                  data-aos="fade-up"
                  data-aos-delay="100"
