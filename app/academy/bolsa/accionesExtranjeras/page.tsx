...
export default function AccionesExtranjeras(this: any) {
  return (
    <>
      <section>
        <BackButton />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4">Acciones en broker extranjeros</h2>
              <p className="text-xl text-gray-400">Compra acciones de manera directa sin pasar por Argentina</p>
            </div>
            {/* Items */}
            <div
